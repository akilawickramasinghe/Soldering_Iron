...
#define ENCODER_CHANNELA_PORT D // A,B,C,D ... port naming
#define ENCODER_CHANNELA_PIN 2 // 1,2,3,4 ... pin naming

#define ENCODER_CHANNELB_PORT D // A,B,C,D ... port naming 
#define ENCODER_CHANNELB_PIN 3 // 1,2,3,4 ... pin naming
